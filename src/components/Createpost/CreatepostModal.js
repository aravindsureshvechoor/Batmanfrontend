...
const CreatepostModal = ({ isOpen, toggle }) => {
  ...
  <ModalBody style={{background:"#131313"}}>
    <div className="editor mx-auto w-10/12 flex flex-col text-gray-300 border border-black-800 p-4 shadow-lg max-w-2xl" style={{ background: '#131313', color: '#ffc700' }}>
      <input className="title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none" spellCheck="false" placeholder="Title" type="text" style={{ background: '#131313', color: '#ffc700' }} />
      {/* Icons */}
  ...
  <ModalFooter>
    <div className="btn border border-gray-300 p-1 px-4 font-semibold cursor-pointer text-gray-500 ml-auto" onClick={toggle} style={{ background: '#131313', color: '#ffc700' }}>Cancel</div>
  </ModalFooter>
</Modal>
